# Contributing to OMOD-Framework

The following is a set of guidelines for contributing to the `erri120/OMOD-Framework` repo on GitHub. These are guidelines but not rules so be free to propose changes.
...
Before creating a new Issue, take a look at the others to avoid getting the [Duplicate](https://github.com/erri120/OMOD-Framework/labels/Duplicate) label.

Creating a bug report is as easy as navigating to the [Issues](https://github.com/erri120/OMOD-Framework/issues) page and clicking the [New Issue](https://github.com/erri120/OMOD-Framework/issues/new/choose) button.
...
* **Include additional data** in the issue. This encompasses your operating system and the version of the Framework.
...
The OMOD-Framework is programmed in C# so having a decent amount of knowledge in that language is good to have. You also want to make sure that you have a basic understanding of the git workflow.
...
2) **Open OMOD-Framework.sln** in Visual Studio 2019
3) **Download NuGet Packages** by selecting the solution and *Right Click*->*Restore NuGet Packages*

It may take a while for Visual Studio to download all packages and update all References so be patience. Once all packages are downloaded go and try building the framework. If the build is successful than good job.
...
`git remote add upstream https://github.com/erri120/OMOD-Framework.git`
